...
const EMMA_INTERVIEW_DATA = {
  ...
  crisis_plan: {
    notes: 'No prior crisis events, hospitalizations, or law enforcement involvement. No suicidal ideation (communication level precludes direct assessment — monitor behavioral indicators). Escalation warning signs: increased rocking speed, high-intensity bilateral flapping, sustained whining escalating to crying. De-escalation (effective): remove all demands, dim lights, offer preferred chew/fidget, wait quietly. Deep pressure (firm hug) effective ~60% per mom report. Avoid: physical restraint without warning, multiple verbal instructions, blocking attempts. Return to baseline: 10-20 min. No medical contraindications. Emergency contacts: Linda Thompson (mom, primary), David Thompson (dad, secondary). Pediatrician: Dr. Sarah Mills.',
    completionState: 'partial',
  },
};
...
const MARCUS_INTERVIEW_DATA = {
  ...
  crisis_plan: {
    notes: 'No prior hospitalization, psychiatric crisis, or law enforcement involvement. No suicidal ideation or self-harm beyond described SIB. No prior formal crisis plan in place. Warning signs (caregiver-identified): increased pacing, elevated delayed echolalia volume/frequency, refusal of eye contact with turned-body posture, high-intensity flapping, repetitive "no"/"I don\'t want to." Escalation sequence: warning signs → verbal protest → motor agitation (pacing/flapping/rocking) → crying/screaming → physical aggression → occasional SIB. De-escalation (effective): quiet low-stimulation space + brief break, 5 min preferred tablet access, deep pressure, low calm voice, single simple statements. Worsen: physical restraint, multiple verbal prompts in sequence, sibling presence during episode, raised voice, extended explanations. Return to baseline: 20-40 min. Post-episode: Marcus often initiates affection and apologizes — remorse awareness present. Medical: Guanfacine ER a.m. dose, no acute effects. No contraindications. Emergency contacts: Daniela Rivera (primary), Javier Rivera (secondary). Treating physician: Dr. Adriana Costa.',
    completionState: 'complete',
  },
};
